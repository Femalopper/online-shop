  ...
  return (
    <section id="page3">
      ...
      <div className="shippment">
        ...
        <img src="../../img/icons8-доставка-64 (1).png" alt="shippment to door" />
        <br />
        <br />
      ...
      <div className="shippment">
        ...
        <img src="../../img/icons8-магазин-64.png" alt="shop" />
        <br />
        <br />
      ...
      <div className="pay">
        <h2>Наличными</h2>
        <img src="../../img/icons8-без-кредитных-карт-64.png" alt="shop" />
        <br />
        <br />
        ...
        проверяйте правильность указания вашего телефонного номера — заказ доставляется только после
        подтверждения. Мы обрабатываем заказы ежедневно с 9:00 до 22:00. Если вы оформите ваш заказ
        ночью, он будет обработан в следующий рабочий день нашего интернет-магазина. Вы всегда
        можете оформить заказ по телефону 8 (800) 700-19-44 и задать все необходимые вопросы нашим
        менеджерам.
      </div>
    </section>
  );
